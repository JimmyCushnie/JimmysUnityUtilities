...
namespace JimmysUnityUtilities
{
    ...
    public class Color32EqualityComparer : EqualityComparer<Color32>
    {
        public static Color32EqualityComparer Instance { get; } = new Color32EqualityComparer();

        public override bool Equals(Color32 x, Color32 y)
            => x.r == y.r && x.g == y.g && x.b == y.b && x.a == y.a;

        public override int GetHashCode(Color32 obj)
