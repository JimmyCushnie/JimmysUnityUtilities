...
namespace JimmysUnityUtilities
{
    ...
    {
        public static Color24 WithoutAlphaChannel(this Color32 rgba)
            => new Color24(rgba.r, rgba.g, rgba.b);

        public static Color24 WithoutAlphaChannel(this Color rgba)
        {
            var color32 = (Color32)rgba;
            return color32.WithoutAlphaChannel();
        }
